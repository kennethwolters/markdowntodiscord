# Blinded critic prompt v2

Read the assigned packet JSONL, `data/loop/rubric-v1.md`, and `data/loop/converter-policy-v1.md` completely. Judge every packet independently and in file order. Apply each packet's `options`; an explicit option overrides the policy default.
